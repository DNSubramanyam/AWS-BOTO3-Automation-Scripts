...
def lambda_handler(event, context):
    #main_exec(event, ins_list)
    ssm_list_cmd_resp = ssm.list_commands(CommandId=event['CommandId'])['Commands'][0]
    target_count = ssm_list_cmd_resp['TargetCount']
    pprint(target_count)
...
if __name__ == "__main__":
    event = {'Bucket': 'run-command-logs-v64', 'CommandId': 'e90d38cd-fda1-4eeb-8dad-5fd265f139e1'}
